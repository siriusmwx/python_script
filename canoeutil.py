...
class CANoe:
    def __init__(self):
        ...
        print('Loaded CANoe version ', self.ver.major, '.', self.ver.minor,
              '.', self.ver.Build, '...')  #, sep,''
    ...
    def open_cfg(self, cfgname):
        ...
        if (self.application != None):
            ...
            if os.path.isfile(cfgname) and (os.path.splitext(cfgname)[1]
                                            == ".cfg"):
            ...
            raise RuntimeError(
                "CANoe Application is missing,unable to open simulation")
    ...
    def close_cfg(self):
        ...
        if (self.application != None):
            ...
            if "CANoe32.exe" in output:
                run("taskkill /im CANoe32.exe /f 2>nul >nul", shell=True)
            self.application = None
    ...
    def start_Measurement(self):
        ...
        while not self.application.Measurement.Running and (retry <
                                                            retry_counter):
